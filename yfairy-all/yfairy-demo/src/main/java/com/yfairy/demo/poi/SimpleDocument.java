...
public class SimpleDocument {
	public static void main(String[] args) throws Exception {
		...
		r5.setText(
				"When we have shuffled off this mortal coil,Must give us pause: there's the respectThat makes calamity of so long life;");
		...
		File wordFile = new File(desktop, "simple.docx");
